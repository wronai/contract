...
> ⚠️ **Dokument historyczny** — opisuje stan z wersji 2.3 (1 Stycznia 2026).  
> Aktualny stan: patrz [22-project-status.md](22-project-status.md).  
> Katalog `pycontracts/` został przeniesiony do `reclapp-contracts/`.  
> Pipeline walidacji ma teraz **8 etapów** (dodano etap Schema).
...
│           ▼                        ▼                                     │
│                                                                          │
│  VALIDATION (7→8 STAGES; see current docs) ────────────────────────────  │
│                                                                          │
│  ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐               │
│  │  1  │ │  2  │ │  3  │ │  4  │ │  5  │ │  6  │ │  7  │               │
│  │Syntx│ │Schma│ │Assrt│ │Statc│ │Test │ │Qualy│ │Secur│ │Runtm│       │
│  │  ✅ │ │  ✅ │ │  ✅ │ │  ✅ │ │  ✅ │ │  ✅ │ │  ✅ │ │  ✅ │       │
│  └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘       │
│                                                                          │
│  FEEDBACK LOOP ────────────────────────────────────────────────────────  │
